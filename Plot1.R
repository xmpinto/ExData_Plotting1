...
ECP <- read.table(file = "/Users/XXX/Desktop/Data_Science/Course 4 - Exploratory Data Analysis/household_power_consumption.txt", sep = ";", header = TRUE, dec = ".", na.strings = "?")
...
write.csv(ECP_Subset2, "/Users/XXX/Desktop/Data_Science/Course 4 - Exploratory Data Analysis/household_power_consumption_subset.csv")

## PLot 1

#reload CSV file and store as ECPNEW
ECPNEW <- read.csv("/Users/XXX/Desktop/Data_Science/hpc_subset.csv", header = TRUE, dec = ".")
